package Flightheadlessapirest.resource.v1_0;
 ...
 *
 *     curl -u your@email.com:yourpassword -D - http://localhost:8080/o/Flightheadlessapirest/v1.0
 *
 * @author Sania Mir
 * @generated
 */
...
public interface FlightResource {
	...
	public Response postFlightBatch(String callbackURL, Object object)
		throws Exception;

	public Flight deleteFlight(Long flightId) throws Exception;

	public Response deleteFlightBatch(String callbackURL, Object object)
		throws Exception;
	...
	public Response putFlightBatch(String callbackURL, Object object)
		throws Exception;
