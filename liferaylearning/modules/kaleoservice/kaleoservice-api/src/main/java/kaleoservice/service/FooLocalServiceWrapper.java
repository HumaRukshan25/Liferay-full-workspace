...
public class FooLocalServiceWrapper
	 ...
	 */
	@Override
	public kaleoservice.model.Foo addFoo(kaleoservice.model.Foo foo) {
	 ...
	 */
	@Override
	public kaleoservice.model.Foo createFoo(long fooId) {
	 ...
	 */
	@Override
	public kaleoservice.model.Foo deleteFoo(kaleoservice.model.Foo foo) {
	 ...
	 */
	@Override
	public kaleoservice.model.Foo deleteFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public kaleoservice.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	@Override
	public kaleoservice.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 */
	@Override
	public kaleoservice.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public kaleoservice.model.Foo getFooByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<kaleoservice.model.Foo> getFoos(int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<kaleoservice.model.Foo> getFoosByUuidAndCompanyId(
	...
	public java.util.List<kaleoservice.model.Foo> getFoosByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<kaleoservice.model.Foo>
			orderByComparator) {
	 ...
	 */
	@Override
	public kaleoservice.model.Foo updateFoo(kaleoservice.model.Foo foo) {
		return _fooLocalService.updateFoo(foo);
	}

	@Override
	public kaleoservice.model.Foo updateStatus(
