...
import kaleoservice.model.FooModel;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"status", Types.INTEGER}, {"field1", Types.VARCHAR},
	...
	public static final String TABLE_SQL_CREATE =
		"create table FOO_Foo (uuid_ VARCHAR(75) null,fooId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,status INTEGER,field1 VARCHAR(75) null,field2 BOOLEAN,field3 INTEGER,field4 DATE null,field5 VARCHAR(75) null)";
	...
	public Foo cloneWithOriginalValues() {
		...
		fooImpl.setStatus(this.<Integer>getColumnOriginalValue("status"));
