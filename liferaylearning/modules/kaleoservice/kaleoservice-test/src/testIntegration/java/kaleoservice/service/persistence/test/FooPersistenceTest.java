...
package kaleoservice.service.persistence.test;
...
import kaleoservice.exception.NoSuchFooException;

import kaleoservice.model.Foo;

import kaleoservice.service.FooLocalServiceUtil;
import kaleoservice.service.persistence.FooPersistence;
import kaleoservice.service.persistence.FooUtil;
...
public class FooPersistenceTest {
	...
	public static final AggregateTestRule aggregateTestRule =
		new AggregateTestRule(
			...
			new TransactionalTestRule(
				Propagation.REQUIRED, "kaleoservice.service"));
	...
	public void testUpdateExisting() throws Exception {
		...
		newFoo.setStatus(RandomTestUtil.nextInt());
		...
		Assert.assertEquals(existingFoo.getStatus(), newFoo.getStatus());
	...
	protected OrderByComparator<Foo> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create(
			...
			true, "modifiedDate", true, "status", true, "field1", true,
	...
	protected Foo addFoo() throws Exception {
		...
		foo.setStatus(RandomTestUtil.nextInt());
