...
public class FIRRRModelImpl extends BaseModelImpl<FIRRR> implements FIRRRModel {
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"incidentDetails", Types.VARCHAR}, {"incidentLocation", Types.VARCHAR},
		{"status", Types.VARCHAR}, {"timeline", Types.VARCHAR},
		{"modificationDetails", Types.VARCHAR},
		{"assignedInspector", Types.VARCHAR}, {"proofFileName", Types.VARCHAR},
		{"proofFilePath", Types.VARCHAR}, {"userId", Types.BIGINT},
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("incidentLocation", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("status", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("timeline", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("modificationDetails", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("assignedInspector", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("proofFileName", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("proofFilePath", Types.VARCHAR);
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put(
				"incidentLocation", FIRRR::getIncidentLocation);
			...
			attributeGetterFunctions.put(
				"assignedInspector", FIRRR::getAssignedInspector);
			attributeGetterFunctions.put(
				"proofFileName", FIRRR::getProofFileName);
			attributeGetterFunctions.put(
				"proofFilePath", FIRRR::getProofFilePath);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"incidentLocation",
				(BiConsumer<FIRRR, String>)FIRRR::setIncidentLocation);
			attributeSetterBiConsumers.put(
			...
			attributeSetterBiConsumers.put(
				"assignedInspector",
				(BiConsumer<FIRRR, String>)FIRRR::setAssignedInspector);
			attributeSetterBiConsumers.put(
				"proofFileName",
				(BiConsumer<FIRRR, String>)FIRRR::setProofFileName);
			attributeSetterBiConsumers.put(
				"proofFilePath",
				(BiConsumer<FIRRR, String>)FIRRR::setProofFilePath);
			attributeSetterBiConsumers.put(
	...
	public String getAssignedInspector() {
		if (_assignedInspector == null) {
			return "";
		}
		else {
			return _assignedInspector;
		}
	}
	...
	public void setAssignedInspector(String assignedInspector) {
		...
		_assignedInspector = assignedInspector;
	}
	...
	public Object clone() {
		...
		firrrImpl.setIncidentLocation(getIncidentLocation());
		firrrImpl.setStatus(getStatus());
		firrrImpl.setTimeline(getTimeline());
		firrrImpl.setModificationDetails(getModificationDetails());
		firrrImpl.setAssignedInspector(getAssignedInspector());
		firrrImpl.setProofFileName(getProofFileName());
		firrrImpl.setProofFilePath(getProofFilePath());
	...
	public FIRRR cloneWithOriginalValues() {
		...
		firrrImpl.setIncidentLocation(
			this.<String>getColumnOriginalValue("incidentLocation"));
		...
		firrrImpl.setAssignedInspector(
			this.<String>getColumnOriginalValue("assignedInspector"));
		firrrImpl.setProofFileName(
			this.<String>getColumnOriginalValue("proofFileName"));
		firrrImpl.setProofFilePath(
			this.<String>getColumnOriginalValue("proofFilePath"));
	...
	public CacheModel<FIRRR> toCacheModel() {
		...
		firrrCacheModel.incidentLocation = getIncidentLocation();

		String incidentLocation = firrrCacheModel.incidentLocation;

		if ((incidentLocation != null) && (incidentLocation.length() == 0)) {
			firrrCacheModel.incidentLocation = null;
		}
		...
		firrrCacheModel.assignedInspector = getAssignedInspector();

		String assignedInspector = firrrCacheModel.assignedInspector;

		if ((assignedInspector != null) && (assignedInspector.length() == 0)) {
			firrrCacheModel.assignedInspector = null;
		}

		firrrCacheModel.proofFileName = getProofFileName();

		String proofFileName = firrrCacheModel.proofFileName;

		if ((proofFileName != null) && (proofFileName.length() == 0)) {
			firrrCacheModel.proofFileName = null;
		}

		firrrCacheModel.proofFilePath = getProofFilePath();

		String proofFilePath = firrrCacheModel.proofFilePath;

		if ((proofFilePath != null) && (proofFilePath.length() == 0)) {
			firrrCacheModel.proofFilePath = null;
		}
	...
	private String _assignedInspector;
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("incidentLocation", _incidentLocation);
		_columnOriginalValues.put("status", _status);
		_columnOriginalValues.put("timeline", _timeline);
		_columnOriginalValues.put("modificationDetails", _modificationDetails);
		_columnOriginalValues.put("assignedInspector", _assignedInspector);
		_columnOriginalValues.put("proofFileName", _proofFileName);
		_columnOriginalValues.put("proofFilePath", _proofFilePath);
	...
	static {
		...
		columnBitmasks.put("incidentLocation", 32L);

		columnBitmasks.put("status", 64L);

		columnBitmasks.put("timeline", 128L);

		columnBitmasks.put("modificationDetails", 256L);

		columnBitmasks.put("assignedInspector", 512L);

		columnBitmasks.put("proofFileName", 1024L);

		columnBitmasks.put("proofFilePath", 2048L);
