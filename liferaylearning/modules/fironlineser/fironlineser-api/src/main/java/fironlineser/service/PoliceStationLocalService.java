...
/**
 * Provides the local service interface for PoliceStation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PoliceStationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PoliceStationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>fironlineser.service.impl.PoliceStationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the police station local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PoliceStationLocalServiceUtil} if injection and service tracking are not available.
	 */
