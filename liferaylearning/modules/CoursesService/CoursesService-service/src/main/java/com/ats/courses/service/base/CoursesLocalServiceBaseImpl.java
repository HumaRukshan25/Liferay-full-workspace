...
import com.ats.courses.service.CoursesLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ats.courses.service.impl.CoursesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ats.courses.service.impl.CoursesLocalServiceImpl
 * @generated
 */
public abstract class CoursesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CoursesLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CoursesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ats.courses.service.CoursesLocalServiceUtil</code>.
	 */
	...
	public Courses createCourses(long coursesId) {
		return coursesPersistence.create(coursesId);
	}
	...
	public Courses deleteCourses(long coursesId)
		...
		return coursesPersistence.remove(coursesId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return coursesPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Courses.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return coursesPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return coursesPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Courses fetchCourses(long coursesId) {
		return coursesPersistence.fetchByPrimaryKey(coursesId);
	}
	...
	public Courses fetchCoursesByUuidAndGroupId(String uuid, long groupId) {
		return coursesPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Courses getCourses(long coursesId) throws PortalException {
		return coursesPersistence.findByPrimaryKey(coursesId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(coursesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Courses.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("coursesId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Courses.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("coursesId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return coursesPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CoursesLocalServiceImpl#deleteCourses(Courses) to avoid orphaned data");
		}

		return coursesLocalService.deleteCourses((Courses)persistedModel);
	}

	@Override
	public BasePersistence<Courses> getBasePersistence() {
	...
	public List<Courses> getCoursesesByUuidAndCompanyId(
		...
		return coursesPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Courses> getCoursesesByUuidAndCompanyId(
		...
		return coursesPersistence.findByUuid_C(
	...
	public Courses getCoursesByUuidAndGroupId(String uuid, long groupId)
		...
		return coursesPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CoursesLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		coursesLocalService = (CoursesLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return CoursesLocalService.class.getName();
	}
	...
	protected CoursesLocalService coursesLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CoursesLocalServiceBaseImpl.class);
