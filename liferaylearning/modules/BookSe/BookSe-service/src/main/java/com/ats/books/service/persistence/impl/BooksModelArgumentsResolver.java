...
/**
 * The arguments resolver class for retrieving value from Books.
 *
...
@Component(
	property = {
		"class.name=com.ats.books.model.impl.BooksImpl",
		"table.name=BOOKKK_Books"
	},
	service = ArgumentsResolver.class
)
public class BooksModelArgumentsResolver implements ArgumentsResolver {
	...
	public String getClassName() {
		return BooksImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return BooksTable.INSTANCE.getTableName();
	}

	private static Object[] _getValue(
		BooksModelImpl booksModelImpl, String[] columnNames, boolean original) {
