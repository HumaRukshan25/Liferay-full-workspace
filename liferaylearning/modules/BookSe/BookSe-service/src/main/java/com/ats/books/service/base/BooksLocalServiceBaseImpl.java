...
import com.ats.books.service.BooksLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ats.books.service.impl.BooksLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.ats.books.service.impl.BooksLocalServiceImpl
 * @generated
 */
public abstract class BooksLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BooksLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BooksLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.ats.books.service.BooksLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return booksPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Books.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return booksPersistence.findWithDynamicQuery(
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<Books>() {
				...
				@Override
				public void performAction(Books books) throws PortalException {
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, books);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return booksPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BooksLocalServiceImpl#deleteBooks(Books) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<Books> getBasePersistence() {
	...
	public List<Books> getBooksesByUuidAndCompanyId(
		...
		return booksPersistence.findByUuid_C(
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BooksLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		booksLocalService = (BooksLocalService)aopProxy;
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BooksLocalServiceBaseImpl.class);
