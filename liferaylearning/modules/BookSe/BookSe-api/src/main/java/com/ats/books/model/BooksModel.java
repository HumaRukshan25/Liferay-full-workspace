...
/**
 * The base model interface for the Books service. Represents a row in the &quot;BOOKKK_Books&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.ats.books.model.impl.BooksModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.ats.books.model.impl.BooksImpl</code>.
 * </p>
 *
...
public interface BooksModel
	extends BaseModel<Books>, GroupedModel, ShardedModel, StagedAuditedModel {
