...
/**
 * Provides the local service interface for BookCategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BookCategoryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BookCategoryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ats.books.service.impl.BookCategoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the book category local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BookCategoryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public BookCategory createBookCategory(long categoryId);
	...
	public BookCategory deleteBookCategory(BookCategory bookCategory);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public BookCategory deleteBookCategory(long categoryId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public BookCategory fetchBookCategory(long categoryId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public BookCategory fetchBookCategoryByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BookCategory> getBookCategories(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BookCategory> getBookCategoriesByUuidAndCompanyId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public BookCategory getBookCategory(long categoryId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public BookCategory getBookCategoryByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
