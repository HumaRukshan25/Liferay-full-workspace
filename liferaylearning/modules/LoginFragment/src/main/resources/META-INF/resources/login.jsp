 ...
 */
--%>
<!-- i did only deploy in gradle it worked     
//for this i selcted liferay module fragment  when creating this module loginfragment 

-->

<%@page import="com.liferay.portal.kernel.dao.orm.Session"%>
<%@ include file="/init.jsp" %>
<h1>This is my new login page for Online FIR Registry system</h1>
...
<!-- OTP form (only shows if Prelogin.java set OTP_REQUIRED=true) -->
