...
package FlightMgmtSystemService.service.persistence.impl;

import FlightMgmtSystemService.exception.NoSuchFooException;

import FlightMgmtSystemService.model.Foo;
import FlightMgmtSystemService.model.FooTable;
import FlightMgmtSystemService.model.impl.FooImpl;
import FlightMgmtSystemService.model.impl.FooModelImpl;

import FlightMgmtSystemService.service.persistence.FooPersistence;
import FlightMgmtSystemService.service.persistence.FooUtil;
import FlightMgmtSystemService.service.persistence.impl.constants.FLIGHTPersistenceConstants;
...
public class FooPersistenceImpl
	...
	@Override
	@Reference(
		target = FLIGHTPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = FLIGHTPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
