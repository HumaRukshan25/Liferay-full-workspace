...
<h2>Enter OTP for loginn</h2>
<p>Please check your email for the OTP and enter it below:</p>
 
 
 <!-- // this is for default admin to verify otpp-->
...
<button 
    style="background-color:#009688; color:white; padding:8px 15px; border:none; border-radius:5px; cursor:pointer;"
    onclick="location.href='${viewProfileURL}'">
    View My Profile
</button>
